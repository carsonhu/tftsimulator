...
def lucky_chance(base_chance):
    """
    Returns the effective probability when checking twice and taking the better outcome.
    formula: 1 - (1 - base_chance)^2
    """
    return 1 - (1 - base_chance) ** 2
